...
BaseRobot.prototype.getServiceVariable = function(serviceName, serviceFunc) {
	if (serviceName && this.services[serviceName] && serviceFunc) {
		return this.services[serviceName][serviceFunc];
	}
	else {
		return null;
	}
...
BaseRobot.prototype.setBTBoardcastPeriod = function setBTBoardcastPeriod(period, callback) {
	...
	this.callServiceFunction("MODULE_PARAMETER", ModuleParameter.prototype.writeBoardcastPeriod, period, callback);
}
